...
namespace menu
{
    class Array
    {
        ...
        public static bool MainMenu(List<string> list)
        {
            Console.Clear();
            ...
            Console.WriteLine("5) Содержание индекса");
            Console.WriteLine("6) Индекс элемента");
            ...
            switch (Console.ReadLine())
            {
                ...
                case "6":
                    ...
                    if(list.IndexOf(val)==-1) Console.WriteLine("Такого элемента нет");
                    else Console.WriteLine("Элемент имеет индекс "+list.IndexOf(val));
                    Console.Write("\r\nНажмите Enter, чтобы вернуться в главное меню");
                    Console.ReadLine();
                    return true;
                case "7":
