...
namespace menu
{
    class Array
    {
        ...
        public static SortedDictionary<int,string> list = new SortedDictionary<int,string>();
        static void Main()
        {
            rgrka = true;
            list.Add(005, "Евгений");
            list.Add(002, "Матвей");
            list.Add(006, "Петр");
            list.Add(004, "Юрий");
        ...
        public static bool MainMenu(SortedDictionary<int,string> list)
        {
            Console.Clear();
        ...
        public static void Add(SortedDictionary<int,string> list)
        {
            Console.Clear();
        ...
        public static void Dlina(SortedDictionary<int,string> list)
        {
            Console.Clear();
        ...
        public static void Chisto(SortedDictionary<int,string> list)
        {
            Console.Clear();
            list.Clear();
            Console.Write("\r\nНажмите Enter, чтобы вернуться в главное меню");
        ...
        public static void ContainsKey(SortedDictionary<int,string> list)
        {
            Console.Clear();
        ...
        public static void ContainsVal(SortedDictionary<int,string> list)
        {
            Console.Clear();
        ...
        public static void Delete(SortedDictionary<int,string> list)
        {
            Console.Clear();
            Console.Write("Введите ключ:\t");
        ...
        public static void GetType(SortedDictionary<int,string> list)
        {
            Console.Clear();
        ...
        public static void Out(SortedDictionary<int,string> list)
        {
            Console.Clear();
        ...
        public static void CopyKey(SortedDictionary<int,string> list)
        {
            Console.Clear();
        ...
        public static void Key(SortedDictionary<int,string> list)
        {
            Console.Clear();
