...
namespace menu
{
    class Array
    {
        ...
        public static bool MainMenu(SortedList list)
        {
            Console.Clear();
        ...
        public static void ContainsVal(SortedList list)
        {
            Console.Clear();
        ...
        public static void Delete(SortedList list)
        {
            Console.Clear();
            Console.Write("Введите ключ:\t");
        ...
        public static void Out(SortedList list)
        {
            Console.Clear();
        ...
        public static void CopyKey(SortedList list)
        {
            Console.Clear();
        ...
        public static void Key(SortedList list)
        {
            Console.Clear();
